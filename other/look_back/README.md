...
* スキル
    * AWSの資格をとってみる
    * node.jsにてライブラリを作成してみる。or deno
    * Vue.jsでもウェブページを作成してみる。
    * CDKの最新を追い続ける
    * ネットワークとインターネットの仕組みを理解する（もう少し具体的に）
    * javascript, typescriptなどの基礎を知り尽くす
    * k8sの概念を理解し、サービスを作成する
    * アウトプットは月2項目くらいは行いたい。
* 仕事
    * 転職先でCI/CD環境の構築
    * OLPをベースに働くようにする
* 今気になること
    * 箱根駅伝のまとめ
    * クレジットカードの伝票まとめ
    * Pythonで動画を作るやつで、ネットワークとかの動画を作ってみたい。
* その他
    * 映画をたくさん見たい
    * ワインを飲みたい
